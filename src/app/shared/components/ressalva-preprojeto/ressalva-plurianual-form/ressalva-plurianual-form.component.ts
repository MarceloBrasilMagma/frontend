...
import { DeclaracoesTrabalhoClient, SituacaoProjetoPlurianualOrcamento, ProjetoPlurianualOrcamentoVm, ProjetosPlurianuaisClient, ProjetoPlurianualOrcamentoAlterarCommand, ProjetoPlurianualOrcamentoAlterarSituacaoCommand } from 'web-api-client';

@Component({
  selector: 'app-ressalva-plurianual-form',
  templateUrl: './ressalva-plurianual-form.component.html',
  styleUrls: ['./ressalva-plurianual-form.component.scss']
})
export class RessalvaPlurianualFormComponent implements OnInit {
  @Input() projetoPlurianualId: number;
  ...
  salvar(situacao?: SituacaoProjetoPlurianualOrcamento) {
    ...
    let req = ProjetoPlurianualOrcamentoAlterarCommand.fromJS({
      ...this.orcamento,
